...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-purple-50 to-yellow-50 overflow-hidden">
        <div className="absolute inset-0 bg-cover bg-center bg-no-repeat" 
             style={{
               backgroundImage: `url('https://readdy.ai/api/search-image?query=Joyful%20children%20party%20scene%20with%20colorful%20balloons%2C%20confetti%2C%20happy%20kids%20playing%20games%2C%20bright%20festive%20atmosphere%2C%20parents%20smiling%20in%20background%2C%20professional%20party%20entertainment%20setting%2C%20vibrant%20celebration%20in%20London&width=1200&height=600&seq=hero1&orientation=landscape')`
             }}>
